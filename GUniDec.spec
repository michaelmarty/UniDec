...
hiddenimportslist=[  # 'plotly','
                 ...
                 #'Python.Runtime.dll', 'FileDialog', 'Dialog',
                 ...
                 'pubsub', 'pubsub.core',
                 #'pubsub.core.publisherbase', 'pubsub.core.kwargs', 'pubsub.core.kwargs.publisher',
                 # 'pubsub.core.kwargs.listenerimpl', 'pubsub.core.kwargs.publishermixin',
                 #'pubsub.core.listenerbase',  'pubsub.core.kwargs.topicargspecimpl', 'pubsub.core.kwargs.topicmgrimpl',
