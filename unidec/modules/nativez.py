...
class NativeZ(wx.Dialog):
    ...
    def initialize_interface(self, massaxis, chargeaxis, igrid, config, pks):
        ...
        self.plot1 = PlottingWindow.Plot1d(sb, figsize=self.figsize)
        self.plot2 = PlottingWindow.Plot1d(sb, figsize=self.figsize)
        self.plot3 = PlottingWindow.Plot1d(sb, figsize=self.figsize)
        self.plot4 = PlottingWindow.Plot1d(sb, figsize=self.figsize)
        self.plot5 = PlottingWindow.Plot1d(sb, figsize=self.figsize)
        self.plot6 = PlottingWindow.Plot1d(sb, figsize=self.figsize)
        self.plot7 = PlottingWindow.Plot2d(sb, figsize=self.figsize)
        ...
        fitbutton = wx.Button(sb, label="Fit")
        resetbutton = wx.Button(sb, label="Reset to Default")
        extractbutton = wx.Button(sb, label="Extract")
        self.ctlmassoffset = wx.TextCtrl(sb, value=str(self.config.massoffset), size=(50, -1))
        self.ctlfilt = wx.RadioBox(sb, label="Extract Shape", choices=["Box", "Gaussian"])
        self.ctlfilt.SetSelection(self.config.extractshape)
        savefigbutton = wx.Button(sb, label="Save Figures")
        replotbutton = wx.Button(sb, label="Replot")
        hbox1.Add(addbutton, 0)
        hbox1.Add(replotbutton, 0)
        hbox1.Add(resetbutton, 0)
        hbox1.Add(wx.StaticText(sb, label="     "), 0, wx.ALIGN_CENTER_VERTICAL)

        hbox1.Add(fitbutton, 0)
        hbox1.Add(extractbutton, 0)
        hbox1.Add(wx.StaticText(sb, label="     Monomer Mass: "), 0)  # , wx.ALIGN_CENTER_VERTICAL)
