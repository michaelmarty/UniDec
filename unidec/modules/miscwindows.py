...
class AdditionalParameters(wx.Dialog):
    ...
    def initialize_interface(self, config):
        ...
        self.inputbox5 = wx.TextCtrl(sb, value=str(self.config.inflate))
        hbox5.Add(wx.StaticText(sb, label='Peak Inflation Parameter: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox5.Add(self.inputbox5, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border=5)
        hbox5.Add(wx.StaticText(sb, label=' x Peak Shape '), 0, wx.ALIGN_CENTER_VERTICAL)
        sbs.Add(hbox5, 1)

        hbox7 = wx.BoxSizer(wx.HORIZONTAL)
        self.inputbox7 = wx.TextCtrl(sb, value=str(self.config.filterwidth))
        hbox7.Add(wx.StaticText(sb, label='# of data points binned for filtering: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox7.Add(self.inputbox7, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border=5)
        sbs.Add(hbox7, 1)

        hbox8 = wx.BoxSizer(wx.HORIZONTAL)
        self.inputbox8 = wx.TextCtrl(sb, value=str(self.config.zerolog))
        hbox8.Add(
            wx.StaticText(sb, label='Value to approximate log(0) or log(negative number) to\n(should be negative): ')
...
class SaveFigureDialog(wx.Dialog):
    ...
    def initialize_interface(self, config):
        ...
        hbox = wx.BoxSizer(wx.HORIZONTAL)
        hbox.Add(wx.StaticText(sb, label="Directory:"), 0, wx.ALIGN_CENTER_VERTICAL)
        self.dirinput = wx.TextCtrl(sb, value=self.directory, size=(300, 20))
        hbox.Add(self.dirinput, 0, wx.EXPAND)
        dirbutton = wx.Button(sb, label="...", size=(20, 20))
        hbox.Add(dirbutton, 1, wx.EXPAND)
        self.Bind(wx.EVT_BUTTON, self.on_choose_dir, dirbutton)
        sbs.Add(hbox, 1)

        hbox5 = wx.BoxSizer(wx.HORIZONTAL)
        self.headerbox = wx.TextCtrl(sb, value=str(self.header), size=(300, 20))
        hbox5.Add(wx.StaticText(sb, label='File Name Header: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox5.Add(self.headerbox, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border=5)
        sbs.Add(hbox5, 1)

        hbox6 = wx.BoxSizer(wx.HORIZONTAL)
        self.extbox = wx.TextCtrl(sb, value=str("png"))
        hbox6.Add(wx.StaticText(sb, label='Extension: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox6.Add(self.extbox, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border=5)
        self.dpibox = wx.TextCtrl(sb, value=str(""), size=(40, 20))
        hbox6.Add(wx.StaticText(sb, label='  DPI: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox6.Add(self.dpibox, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border=5)
        self.tbox = wx.CheckBox(sb, label=str("Transparent"))
        hbox6.Add(self.tbox, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border=5)
        sbs.Add(hbox6, 1)

        hbox6b = wx.BoxSizer(wx.HORIZONTAL)
        self.widebox = wx.TextCtrl(sb, value=str(6), size=(40, 20))
        self.tallbox = wx.TextCtrl(sb, value=str(5), size=(40, 20))
        hbox6b.Add(wx.StaticText(sb, label='Figure Size: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox6b.Add(self.widebox, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border=5)
        hbox6b.Add(wx.StaticText(sb, label=' wide by '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox6b.Add(self.tallbox, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border=5)
        hbox6b.Add(wx.StaticText(sb, label=' tall (inches) '), 0, wx.ALIGN_CENTER_VERTICAL)
        sbs.Add(hbox6b, 1)

        hbox8 = wx.BoxSizer(wx.HORIZONTAL)
        size = (40, 20)
        self.b1 = wx.TextCtrl(sb, value=str(0.11), size=size)
        self.b2 = wx.TextCtrl(sb, value=str(0.11), size=size)
        self.b3 = wx.TextCtrl(sb, value=str(0.75), size=size)
        self.b4 = wx.TextCtrl(sb, value=str(0.8), size=size)
        hbox8.Add(wx.StaticText(sb, label='Plot Position: '), 0, wx.ALIGN_CENTER_VERTICAL)
        ...
        hbox8.Add(wx.StaticText(sb, label=' Left Bottom Width Height (%) '), 0, wx.ALIGN_CENTER_VERTICAL)
        sbs.Add(hbox8, 1)
...
class FileNameDialog(wx.Dialog):
    ...
    def initialize_interface(self, config):
        ...
        self.inputbox = wx.TextCtrl(sb, value=self.config.infname)
        hbox1.Add(wx.StaticText(sb, label='Input File Name: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox1.Add(self.inputbox, 1, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, border=5)
        sbs.Add(hbox1, 0, wx.EXPAND)

        hbox2 = wx.BoxSizer(wx.HORIZONTAL)
        self.confbox = wx.TextCtrl(sb, value=self.config.confname)
        hbox2.Add(wx.StaticText(sb, label='Configuration File Name: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox2.Add(self.confbox, 1, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, border=5)
        sbs.Add(hbox2, 0, wx.EXPAND)

        hbox3 = wx.BoxSizer(wx.HORIZONTAL)
        self.outputbox = wx.TextCtrl(sb, value=self.config.outfname)
        hbox3.Add(wx.StaticText(sb, label='Output File Headers: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox3.Add(self.outputbox, 1, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, border=5)
        sbs.Add(hbox3, 0, wx.EXPAND)

        hbox4 = wx.BoxSizer(wx.HORIZONTAL)
        self.massbox = wx.TextCtrl(sb, value=self.config.mfile)
        hbox4.Add(wx.StaticText(sb, label='Mass List File Name: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox4.Add(self.massbox, 1, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, border=5)
        sbs.Add(hbox4, 0, wx.EXPAND)

        hbox5 = wx.BoxSizer(wx.HORIZONTAL)
        self.manualbox = wx.TextCtrl(sb, value=self.config.manualfile)
        hbox5.Add(wx.StaticText(sb, label='Manual File Name: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox5.Add(self.manualbox, 1, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, border=5)
        sbs.Add(hbox5, 0, wx.EXPAND)

        hbox6 = wx.BoxSizer(wx.HORIZONTAL)
        self.obox = wx.TextCtrl(sb, value=self.config.ofile)
        hbox6.Add(wx.StaticText(sb, label='Oligomer File Name: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox6.Add(self.obox, 1, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, border=5)
        sbs.Add(hbox6, 0, wx.EXPAND)

        hbox6b = wx.BoxSizer(wx.HORIZONTAL)
        self.matchbox = wx.TextCtrl(sb, value=self.config.matchfile)
        hbox6b.Add(wx.StaticText(sb, label='Match File Name: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox6b.Add(self.matchbox, 1, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, border=5)
        sbs.Add(hbox6b, 0, wx.EXPAND)

        hbox8 = wx.BoxSizer(wx.HORIZONTAL)
        self.peakbox = wx.TextCtrl(sb, value=self.config.peaksfile)
        hbox8.Add(wx.StaticText(sb, label='Peak File Name: '), 0, wx.ALIGN_CENTER_VERTICAL)
        hbox8.Add(self.peakbox, 1, flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, border=5)
        sbs.Add(hbox8, 0, wx.EXPAND)

        hbox9 = wx.BoxSizer(wx.HORIZONTAL)
        self.dirbox = wx.TextCtrl(sb, value=self.config.dirname)
        hbox9.Add(wx.StaticText(sb, label='Working Directory: '), 0, wx.ALIGN_CENTER_VERTICAL)
